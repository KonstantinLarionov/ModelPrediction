    ...
    class PredictionDataVM
    {
        ...
        public static void DrawMainData(CartesianChart cc1, CartesianChart cc2, double[] data)
        {
            try
            {
                ...
                pen3.DrawAreas(AnaliticDataVM.AreaValue, data.Length-1);
            }
            catch
            {
        ...
        public static void GetAnaliticsPoly(CartesianChart cc, DataGrid dgv, double[] data, int x, int y)
        {
            ...
            double[] arr_analitics = PredictionUpdate.Prediction(buffer.ToList(), 0).ToArray();
        ...
        public static void GetPredictionPoly(CartesianChart cc, double[] data, int x, int y, int number)
        {
            ...
            double[] arr_analitics = PredictionUpdate.Prediction(buffer.ToList(), number).ToArray();
            arr_data = arr_analitics;
            pen.DrawLinerChart(arr_analitics, x, "Прогноз");
        }
